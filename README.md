...
1.  **Create a Gatsby site.**
    ...
    Use the Gatsby CLI to create a new site, specifying the Jooe starter.

    ```sh
    # create a new Gatsby site using the Jooe starter
    gatsby new Jooe-starter https://github.com/niklasmtj/gatsby-starter-Jooe
    ```
...
1.  **Open the source code and start editing!**
    ...
    Open the `Jooe-starter` directory in your code editor of choice and edit `src/pages/index.js` or `src/pages/blog.js`. Save your changes and the browser will update in real time!
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/niklasmtj/gatsby-starter-Jooe)
